...
public class UserstorySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UserstoryPackage.MEANS: {
				means means = (means)theEObject;
				T result = casemeans(means);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UserstoryPackage.END: {
				end end = (end)theEObject;
				T result = caseend(end);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UserstoryPackage.ACTION_VERB: {
				actionVerb actionVerb = (actionVerb)theEObject;
				T result = caseactionVerb(actionVerb);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>action Verb</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>action Verb</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseactionVerb(actionVerb object) {
		return null;
	}
